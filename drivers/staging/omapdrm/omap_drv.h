...
struct omap_drm_private {
	...
	/* TODO split out into several lists to track object state at
	 * some point later (ie. when we start tracking unpinned but not
	 * yet unmapped objects).. for now this is sufficient
	 */
